...
fun ScheduleTimePicker(
    ...
    PickerDialog(
        ...
        title = { Text(stringResource(R.string.select_hour)) },
        buttons = {
    ...
    when (displayMode) {
        DisplayMode.Picker -> IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.switch_to_keyboard_input),
            )
        }
        ...
        DisplayMode.Input -> IconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.switch_to_clock_input),
            )
        }
    }
}
